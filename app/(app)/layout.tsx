...
import { getRpcUrl, getMultisigAddress, getSquadsProgramID, getTokenProgramID } from "@/config/params";
...
const isValidPublicKey = async (multisigString: string) => {
  try {
    ...
    console.log("try multisig.accounts.Multisig.fromAccountAddress:"+multisigString);
    console.log(info);
